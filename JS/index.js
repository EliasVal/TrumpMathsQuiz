...
function updatePassUI_signup(passObj) {
    ...
    if (res.longEnough)
        reqsElm.children[0].style.color = "#3d7b2f";
    else
        reqsElm.children[0].style.color = "#8b0000";
    if (res.hasUppercase)
        reqsElm.children[1].style.color = "#3d7b2f";
    else
        reqsElm.children[1].style.color = "#8b0000";
    if (res.hasLowercase)
        reqsElm.children[2].style.color = "#3d7b2f";
    else
        reqsElm.children[2].style.color = "#8b0000";
    if (res.hasDigit)
        reqsElm.children[3].style.color = "#3d7b2f";
    else
        reqsElm.children[3].style.color = "#8b0000";
    if (res.hasSpecialSymbol)
        reqsElm.children[4].style.color = "#3d7b2f";
    else
        reqsElm.children[4].style.color = "#8b0000";
    if (!res.isValid) {
